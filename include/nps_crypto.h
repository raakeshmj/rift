/* nps_crypto.h — ChaCha20 encryption (RFC 8439, 256-bit key, 96-bit nonce) */
...
/* ── Key / Nonce Sizes ───────────────────────────────────────────── */
#define NPS_CHACHA20_KEY_SIZE 32   /* 256 bits */
#define NPS_CHACHA20_NONCE_SIZE 12 /* 96 bits  */
#define NPS_CHACHA20_BLOCK_SIZE 64 /* 512 bits */
