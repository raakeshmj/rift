/* rift_rtt.h — RTT estimation (Jacobson/Karels, RFC 6298) */
 ...
 */
static inline double rift_rtt_get_rto(const rift_rtt_estimator_t *est) {
  return est->rto_ms;
}
 ...
 */
static inline double rift_rtt_get_srtt(const rift_rtt_estimator_t *est) {
  return est->srtt_ms;
}
